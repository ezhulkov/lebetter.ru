...
function niceform(nf) {
	nf._inputText = new Array(); nf._inputRadio = new Array(); nf._inputCheck = new Array(); nf._inputSubmit = new Array(); nf._inputReset = new Array(); nf._inputFile = new Array(); nf._textarea = new Array(); nf._select = new Array(); nf._multiselect = new Array();
    ...
    nf.add_inputReset = function(obj) {this._inputReset[this._inputReset.length] = obj; inputReset(obj);}
	...
	nf.start = function() {
		...
		for(var w = 0; w < allInputs.length; w++) {
			switch(allInputs[w].type) {
				...
				case "submit": case "button": {this.add_inputSubmit(allInputs[w]); break;}
                case "reset": {this.add_inputReset(allInputs[w]); break;}
        ...
        for(w = 0; w < this._inputReset.length; w++) {this._inputReset[w].init();}
	...
	nf.unload = function() {
        ...
        for(w = 0; w < this._inputReset.length; w++) {this._inputReset[w].unload();}
...
function inputReset(el) { //extend Buttons Reset
	el.oldClassName = el.className;
	el.left = document.createElement('img');
	el.left.className = "NFButtonResLeft";
	el.left.src = imagesPath + "0.gif";
	el.right = document.createElement('img');
	el.right.src = imagesPath + "0.gif";
	el.right.className = "NFButtonResRight";
	el.onmouseover = function() {
		this.className = "NFButtonRes NFh";
		this.left.className = "NFButtonResLeft NFh";
		this.right.className = "NFButtonResRight NFh";
	}
	el.onmouseout = function() {
		this.className = "NFButtonRes";
		this.left.className = "NFButtonResLeft";
		this.right.className = "NFButtonResRight";
	}
	el.init = function() {
		this.parentNode.insertBefore(this.left, this);
		this.parentNode.insertBefore(this.right, this.nextSibling);
